...
public class ColorDB
{
    public static Dictionary<ConditionID, Color> StatusColors = new Dictionary<ConditionID, Color>()
        {
            ...
            { ConditionID.hydro, new Color32(78, 156, 212, 255) },
            { ConditionID.pyro, new Color32(172, 50, 50, 255) },
            { ConditionID.cryo, new Color32(116, 200, 182, 255) },
            { ConditionID.dendro, new Color32(152, 208, 13, 255) },
            { ConditionID.anemo, new Color32(111, 194, 157, 255) },
            { ConditionID.geo, new Color32(215, 168, 0, 255) },
            { ConditionID.electro, new Color32(168, 106, 213, 255) },
        };
    ...
    public static Dictionary<string, Color> textColors = new Dictionary<string, Color>()
    {
        ...
        { "HasCatched", new Color32(0,164,0,255) },
    };
}
